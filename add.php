            ...
            <div class="container">
                ...
                <form action="submit.php" method="post" style="width: 493px;">
                    ...
                    <div class="mb-3"><label class="form-label text-muted" for="subject"
                            style="text-align: right;">Website URL</label><input class="form-control item"
                            name="website" type="text" id="subject" style="width: 399px;"></div>
                    <div class="mb-3"><label class="form-label text-muted" for="email"
                            ...
                            class="form-control item" type="email" id="email" style="width: 399px;"></div>
                    <div class="mb-3"><label class="form-label text-muted" for="message"
                            ...
                            id="message" style="width: 399px;" name="description"></textarea></div>
